...
<div style="margin-left:-10px;">
    ...
    <tr>
     ...
     <td>
       ...
       <td class='font accnt3'><?php echo $row->bankaccount3; ?></td>
     			...
     			<button type="button" class="btn btn-primary send-report" style="float:right; margin-top:-10px;">Send</button>
	...
	<div class="span5" style="margin-top:5px;">
		...
		<table class="table table-bordered  span5" >
			...
			<tr class="show1" style=" text-decoration:none; font-weight:lighter; border:1px solid black;">
				<td>
...
/*	 $(".campaign-report").click(function(){
      ...
      var username = $(this).next().next().attr('name')
      data = "username=" + campaignid + "&campaignid=" + campaignid;
      alert(campaignid);

      	$(this).parent().first().next().next().modal("show");
...
$('.campaign-report').click(function(){
  ...
  $('.bankselect').change(function(){
    ...
    bank1 = $(this).parent().parent().next().find('.bank1');
    bank2 = $(this).parent().parent().next().find('.bank2');
    bank3 = $(this).parent().parent().next().find('.bank3');
...
$('.bankreport').change(function(){
	...
	$('.send-report').stop(true, true).click(function(){
		...
		$.ajax({
			url: "campaign/report/"+campaignid+"/"+datefrom+"/"+dateto+"/"+bankchosen,
			type: "GET",
			data: {
					campaignid : $(this).next().val(),
					datefrom   : $(this).prev().first().find('.datefrom').val(),
