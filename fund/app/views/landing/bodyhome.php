<style type="text/css">
  ...
  img.gallery{
   ...
   <!--carousel -->
        <div id="this-carousel-id" class="carousel slide" style="margin-bottom:30px;">
        <div class="carousel-inner">

          <div class="item active carousel-div" >
            <img class="gallery" src="images/gallery/createfra.png" style="height:315px">
          ...
          <div class="item carousel-div">
            <img class="gallery"  src="images/gallery/campaign.png" style="height:315px">
            <div class="carousel-caption">
              <p>Gallery2</p>
          ...
          <div class="item carousel-div">
            <img class="gallery" src="images/gallery/contri.png" style="height:315px">
            <div class="carousel-caption">
              <p>Gallery3</p>
          ...
          <div class="item carousel-div">
            <img class="gallery"  src="images/gallery/donation.png" style="height:315px">
            <div class="carousel-caption">
              <p>Gallery4</p>
          ...
          <div class="item carousel-div">
            <img class="gallery" src="images/gallery/helpdesk.png" style="height:315px">
            <div class="carousel-caption">
              <p>Gallery5</p>
