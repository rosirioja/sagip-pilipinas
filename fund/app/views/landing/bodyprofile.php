					...
					<div class="widget-tp">
						...
						<div class="row-fluid">
							<div class="span5" style="">
								<img src="<?php echo $profilepic; ?>" style="width:145px;height:145px;"><br>
						...
						<div class="row editpicture-div" style="margin-top:10px; display:none;">
							<div class="span4 fileupload fileupload-new" data-provides="fileupload">
							  ...
							  <div>
							    ...
							    <a href="" style="cursor:ponter;" class="btn btn-danger btn-small fileupload-exists" data-dismiss="fileupload">Remove</a>
							    <a  href="" style="cursor:ponter;" class="btn btn-success btn-small fileupload-exists uploadpicture-btn" >Upload</a>
							  </div>
							  </form>
							</div>
						</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".editpicture-btn").click(function(e){
		 ...
		 $('.uploadpicture-btn').click(function(){ 
			           //$("#preview").html('');
		 ...
		 $('.create-campaign-btn').click(function(){
		 		...
		 		// 		'specificdate' : $('.specificdate').val(),
		 		// 		'name' : $('.campname').val(),
		 		// 		'description' : $('.campdesc').val(),
		 		// 		'location' : $('.camplocation').val(),
		 		// 		'contact' : $('.campcontact').val(),
		 		// 		'bankname' : $('.campbankname').val(),
		 		// 		'bankaccount' : $('.campbankaccount').val()
		 		// 	},
		 		// 	success: function(data){
		 		// 		console.log('success');
		 		// 	}
		...
		$(".chat-send-btn").click(function(){
			...
			$.ajax({
				...
				data : {
						chatmsg : chatmsg,
						user : username,
						userpic : 'images/users/'+username+'.jpg',
						to : "admin"
				},
				success : function(){
					console.log('success');
		...
		$('.chat-wrapper').slimScroll({
		 ...
		 //$(".tab1-content").load('/campaign/view/jethdeguzman');
	});	
</script>
