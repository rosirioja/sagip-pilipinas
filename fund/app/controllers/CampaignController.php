...
*/
		...
		foreach ($report as $data) {
			$stringreport .= "<tr class='append-tr'><td><small class='font'><strong>".$data->datedonated."</strong></small></td><td><small class='font'><strong>".$data->username."</strong></small></td><td><small class='font'><strong>".$data->bankname."</strong></small></td><td><small class='font'><strong>".$data->bankaccount."</strong></small></td><td><small class='font'><strong>".$data->amountdonated."</strong></small></td></tr>";
		}
		return $stringreport;
	}
...
*/					switch ($sort) {
					...
					$data = array('data'=>$result, 'totalpages'=>$totalpages,'logstatus'=>$logstatus);
					return View::make('landing.bodycampaign')->with($data);
				}elseif ($type == "funded"){
